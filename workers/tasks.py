from libs.use_cases import ThoughtUseCases, ConversationUseCases, GenerationUseCases
...
def generate_conversation_message(conversation_id, persona_id):
    ...
    message_contents = conversation_uc.generate_conversation_message(conversation_id, persona_id)
